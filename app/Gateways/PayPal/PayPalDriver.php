...
/**
 * PayPal Checkout (Orders API v2) — carteira PayPal no checkout.
 * Isolado do fluxo de cartão/PIX das demais adquirentes.
 *
...
class PayPalDriver implements GatewayDriver
{
    ...
    public function createPixPayment(
        ...
        throw new \RuntimeException('PayPal não suporta PIX neste gateway.');
    }
    ...
    public function createBoletoPayment(
        ...
        throw new \RuntimeException('PayPal não suporta boleto neste gateway.');
    }
